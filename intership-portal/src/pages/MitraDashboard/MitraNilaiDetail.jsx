...
import { deleteNilaiMitra } from '../../redux/Action/NilaiAction'
import { toast } from 'react-toastify'

const MitraNilaiDetail = () => {
    ...
    const handleDelete = (id) => {
        ...
        if (confirm) {
            dispatch(deleteNilaiMitra(data))
                        ...
                        <div className='flex flex-col sm:flex-row gap-2 justify-between'>
                            ...
                            <div className='flex-col gap-4'>
                                ...
                                <div className='flex gap-2 sm:self-center mt-2'>
                                    <a href={`/mitra-dashboard/update-nilai/${nilai.Nilai.id}`}>
...
export default MitraNilaiDetail
