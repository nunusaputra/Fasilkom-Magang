            ...
            <div className='bg-slate-50 drop-shadow-xl rounded-lg p-4'>
                <div className='flex flex-col sm:flex-row justify-between gap-2'>
                    ...
                    <Link to={"/mitra-dashboard/create-nilai"}>
                        <button className='bg-secondary text-white font-bold px-4 py-2 rounded-md w-full sm:w-48 mt-3'>Create Nilai</button>
                    </Link>
                </div>
                                ...
                                currentPost.length > 0 ? (
                                    ...
                                    <tr className=''>
                                        <td colSpan={50} className='text-center' style={{ height: '100px', verticalAlign: 'middle' }}>
                                            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' }}>
                                                <DataNotFound>
                                                    {search ? 'Your search result not found' : 'Belum ada nilai magang'}
                                                </DataNotFound>
                                            </div>
                                        </td>
                                    </tr>
