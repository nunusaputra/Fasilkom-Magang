...
const MagangReguler = () => {
    ...
    const filterReguler = Array.isArray(pengajuan) ? pengajuan.filter(reguler => search.toLowerCase() === "" || reguler.nama.toLowerCase().includes(search.toLowerCase())) : []

    const lastPostIndex = currentPage * postPerPage
    const firstPostIndex = lastPostIndex - postPerPage
    const currentPost = filterReguler.slice(firstPostIndex, lastPostIndex)
    useEffect(() => {
                ...
                <div className='mt-10'>
                    ...
                    {!Loading && (
                        <Pagination
                            ...
                            totalPost={filterReguler.length}
