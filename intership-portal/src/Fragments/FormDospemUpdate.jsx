...
const FormDospemUpdate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true)
        try {
            const response = await axios.put(`${import.meta.env.VITE_API_URL_MHS}/dosen-pembimbing/${id}`, input, {
                headers: {
        ...
        <div>
            {isLoading ? (
                <div className="flex justify-center items-center h-screen">
                    <HashLoader color="#00BFFF" size={50} />
                </div>
            ) : (
                    ...
                    <div className='grid grid-cols-1 gap-2 sm:grid-cols-2'>
                        ...
                        <div className='mb-3'>
                            <InputForm
                                ...
                                onChange={handleInput}
                            />
                            <p className='text-xs text-slate-500'>Template Surat Covid
                                <a href="https://drive.google.com/file/d/1usMTJP76VYe6pXkqz8kmCXyEuA1O1BqM/view" target='_blank'>
                                    Click Me
                                </a>
                            </p>
                        </div>
                        <div className='mb-3'>
                            <InputForm
                                ...
                                onChange={handleInput}
                            />
                            <p className='text-xs text-slate-500'>Upload Surat Balasan / Surat pernyataan diterima magang di sini</p>
                        </div>
                    </div>
                    <InputForm
                        label="Tempat Magang"
...
export default FormDospemUpdate
