...
const FormProfileDosen = () => {
        ...
        const getUserById = async () => {
            try {
                const response = await axios.get(
                    `${import.meta.env.VITE_API_URL_DOSPEM}/profile/${id}`, {
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true)
        try {
            await axios.put(`${import.meta.env.VITE_API_URL_DOSPEM}/edit/${id}`, input, {
                headers: {
                    Authorization: `Bearer ${user.token}`
                }
            })
...
export default FormProfileDosen
